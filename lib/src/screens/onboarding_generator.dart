...
class OnboardingGeneratorState extends State<OnboardingGenerator> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Onboarding generator'),
      ),
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      Expanded(
                        ...
                        (index, item) => store.editCompanyResource(index, item),
      ...
      builder: (_) {
        return Container(
          ...
          decoration: BoxDecoration(
            border: Border.all(
                color: Colors.blueAccent), // Add border to the main box
            borderRadius:
                        ...
                        itemBuilder: (context, index) {
                          return Container(
                            decoration: BoxDecoration(
                              border: Border.all(
                                  color: Colors
                                      .blueAccent), // Add border to each requirement
  ...
  Widget _generateOnboardingButton() {
    return ElevatedButton(
      ...
      child: const Text('Generate Onboarding Steps'),
    );
  }
}
